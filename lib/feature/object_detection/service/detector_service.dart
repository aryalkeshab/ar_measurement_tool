...
import 'package:ar_measurement_tool/feature/object_detection/utils/image_utils.dart';
  ...
  Map<String, dynamic> analyseImage(
    ...
    return {
      ...
      "stats": <String, String>{
        ...
        'Image size': '${imageInput.width} X ${imageInput.height}',
        // 'Object Size': recognitions.first.location.bottomCenter.toString(),
      },
    };
  }
